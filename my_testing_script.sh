...
# php.ini
sed -i 's/^memory_limit.*$/memory_limit = 512M/g' /home/rof/.phpenv/versions/$(phpenv version-name)/etc/php.ini
sed -i 's/^;always_populate_raw_post_data.*$/always_populate_raw_post_data = -1/g' /home/rof/.phpenv/versions/$(phpenv version-name)/etc/php.ini
